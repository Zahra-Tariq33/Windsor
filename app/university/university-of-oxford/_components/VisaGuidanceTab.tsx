...
export default function VisaGuidanceTab() {
  return (
    <GuidanceSection
      ...
      steps={[
        {
          text: "Obtain CAS (Confirmation of Acceptance for Studies) from Oxford",
        ...
        {
          text: "Show evidence of sufficient funds (tuition + living costs)",
          icon: <LuCircleCheckBig size={28} />,
        },
        {
      ...
      notice={{
        ...
        description: [
          "Our experienced visa counselors have helped thousands of students secure their study visas. Let us handle the complexities while you focus on your preparation.",
        ],
